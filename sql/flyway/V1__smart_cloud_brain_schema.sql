...
INSERT INTO doctor (id, name, phone, password_hash, department_id, title, specialty, status) VALUES
  (1, '张医生', '13900000001', '{bcrypt}$2a$12$u7TPtMrkgSKTxjIj7cACBOW1CdobARmBR0Hr8CwCMDxYMwsypQiiu', 1, '主任医师', '胸痛、心悸、高血压', 'ENABLED'),
  (2, '李医生', '13900000002', '{bcrypt}$2a$12$u7TPtMrkgSKTxjIj7cACBOW1CdobARmBR0Hr8CwCMDxYMwsypQiiu', 2, '主治医师', '发热、咽痛、腹泻、皮肤过敏', 'ENABLED'),
  (3, '王医生', '13900000003', '{bcrypt}$2a$12$u7TPtMrkgSKTxjIj7cACBOW1CdobARmBR0Hr8CwCMDxYMwsypQiiu', 3, '副主任医师', '咳嗽、哮喘、肺部感染', 'ENABLED')
...
INSERT INTO admin_user (id, username, password_hash, name, status) VALUES
  (1, 'admin', '{bcrypt}$2a$12$u7TPtMrkgSKTxjIj7cACBOW1CdobARmBR0Hr8CwCMDxYMwsypQiiu', '系统管理员', 'ENABLED')
