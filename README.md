...
本仓库用于整理“东软智慧云脑诊疗平台”课程实践项目文档。项目基于 Spring Boot 3 + Vue 3 前后端分离架构，包含患者端、医生端、管理端三个使用入口，围绕患者注册登录、智能分诊、在线挂号、医生问诊、AI 病历生成、AI 处方审核、基础数据维护和诊疗记录查看形成完整业务闭环，并将图片中的六项任务全部作为必做交付项。
