package com.smartcloudbrain.prescription.client;
...
import com.smartcloudbrain.prescription.config.FeignClientConfig;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.PostMapping;
import org.springframework.web.bind.annotation.RequestBody;

@FeignClient(name = "ai-service", url = "${services.ai.base-url}", configuration = FeignClientConfig.class)
