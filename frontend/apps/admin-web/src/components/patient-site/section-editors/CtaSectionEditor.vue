    ...
    <div class="config-grid two">
      <div>
        <div class="nested-list-head">
          ...
          <button v-if="!section.primary" type="button" class="topbar-refresh" @click="section.primary = emptyLink()">Add</button>
        </div>
      ...
      <div>
        <div class="nested-list-head">
          ...
          <button v-if="!section.secondary" type="button" class="topbar-refresh" @click="section.secondary = emptyLink()">Add</button>
        </div>
