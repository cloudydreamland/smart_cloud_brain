    ...
    <div class="dashboard">
      ...
      <div class="metrics">
        <div class="metric-card">
          <div class="metric-label"><span>科室</span></div>
          <div class="metric-value">{{ departments.length }}</div>
        </div>
        <div class="metric-card">
          <div class="metric-label"><span>医生</span></div>
          <div class="metric-value blue">{{ doctors.length }}</div>
        </div>
        <div class="metric-card">
          <div class="metric-label"><span>药品</span></div>
          <div class="metric-value">{{ drugs.length }}</div>
        </div>
        <div class="metric-card">
          <div class="metric-label"><span>待处理分诊</span></div>
