...
<template>
  <section class="panel">
    <header class="panel-header"><div class="panel-title"><p class="eyebrow">PRESCRIPTIONS</p><h2>处方列表</h2><p>查看处方和风险审核结果。</p></div><button type="button" @click="refresh">刷新</button></header>
