...
export const useAdminWorkflowStore = defineStore("adminWorkflow", () => {
  ...
  async function refresh() {
    ...
    const [departmentList, doctorList, drugList, scheduleList, triageList, aiLogList] = await Promise.all([
  ...
  return { departments, doctors, drugs, suggestions, schedules, triageDesk, aiLogs, selectedScheduleSuggestion, selectedTriage, refreshErrors, refresh };
});
