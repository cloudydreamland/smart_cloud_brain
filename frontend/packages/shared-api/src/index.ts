...
export const api = {
  ...
  saveDepartment: (token: string, body: unknown) => request<Record<string, unknown>>("/admin/department/save", { method: "POST", body: JSON.stringify(body) }, token),
  saveDoctor: (token: string, body: unknown) => request<Record<string, unknown>>("/admin/doctor/save", { method: "POST", body: JSON.stringify(body) }, token),
  saveDrug: (token: string, body: unknown) => request<Record<string, unknown>>("/admin/drug/save", { method: "POST", body: JSON.stringify(body) }, token),
  prompts: (token: string) => request<Array<Record<string, unknown>>>("/admin/prompt-template/list", {}, token),
  savePrompt: (token: string, body: unknown) => request<Record<string, unknown>>("/admin/prompt-template/save", { method: "POST", body: JSON.stringify(body) }, token),
  knowledgeEntries: (token: string) => request<Array<Record<string, unknown>>>("/admin/knowledge/list", {}, token),
  saveKnowledgeEntry: (token: string, body: unknown) => request<Record<string, unknown>>("/admin/knowledge/save", { method: "POST", body: JSON.stringify(body) }, token),
