...
export const patientApi = {
  ...
  triage: (body: TriageRequest | string) => post<DataRow>("/triage/consult", typeof body === "string" ? { chiefComplaint: body } : body),
  triageList: () => get<DataRow[]>("/triage/list"),
  registrationSlots: () => get<DataRow[]>("/registration/slots"),
  registrations: () => get<DataRow[]>("/registration/list"),
  createRegistration: (body: RegistrationCreateRequest) => post<DataRow>("/registration/create", body),
  cancelRegistration: (registrationId: number) => post<DataRow>("/registration/cancel", { registrationId }),
  completeRegistration: (registrationId: number) => post<DataRow>("/registration/complete", { registrationId }),
  medicalRecords: () => get<DataRow[]>("/medical-record/list"),
  medicalRecordDetail: (id: number) => get<DataRow>(`/medical-record/detail${query({ id })}`),
  prescriptions: () => get<DataRow[]>("/prescription/list"),
  prescriptionDetail: (id: number) => get<DataRow>(`/prescription/detail${query({ id })}`),
  saveProfile: (body: PatientSaveRequest) => post<DataRow>("/patient/profile/save", body),
  visitors: () => get<DataRow[]>("/patient/visitor/list"),
...
export const doctorApi = {
  ...
  generateMedicalRecord: (body: MedicalRecordGenerateRequest) => post<DataRow>("/medical-record/generate", body),
  saveMedicalRecord: (body: MedicalRecordSaveRequest) => post<DataRow>("/medical-record/save", body),
  checkPrescription: (body: PrescriptionCheckRequest) => post<DataRow>("/prescription/check", body),
  ...
  schedules: (params: StatisticsQuery & { status?: string } = {}) => get<DataRow[]>(`/doctor/schedule/list${query(params)}`),
};
