...
export const patientApi = {
  ...
  payRegistration: (registrationId: number) => post<Registration>("/registration/pay", { registrationId }),
  cancelRegistration: (registrationId: number) => post<Registration>("/registration/cancel", { registrationId }),
  checkInRegistration: (registrationId: number) => post<Registration>("/registration/check-in", { registrationId }),
  refundRegistration: (registrationId: number) => post<Registration>("/registration/refund", { registrationId }),
...
export const doctorApi = {
  ...
  registrations: () => get<Registration[]>("/doctor/queue"),
  allRegistrations: () => get<Registration[]>("/registration/list"),
  joinRegistrationQueue: (registrationId: number) => post<Registration>("/registration/join-queue", { registrationId }),
  callRegistration: (registrationId: number) => post<Registration>("/registration/call", { registrationId }),
  startRegistrationConsultation: (registrationId: number) => post<Registration>("/registration/start-consultation", { registrationId }),
...
export const api = {
  ...
  payRegistration: patientApi.payRegistration, cancelRegistration: patientApi.cancelRegistration,
  checkInRegistration: patientApi.checkInRegistration, refundRegistration: patientApi.refundRegistration,
  joinRegistrationQueue: doctorApi.joinRegistrationQueue, callRegistration: doctorApi.callRegistration,
  startRegistrationConsultation: doctorApi.startRegistrationConsultation, completeRegistration: doctorApi.completeRegistration,
